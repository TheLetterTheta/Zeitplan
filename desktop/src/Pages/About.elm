...
view shared model =
    ...
    , body =
        [ zeitplanNav
            { logo = shared.logo
            , shared = shared
            , logout = SharedMsg Shared.ToggleNavbarHamburger
            ...
            [ container []
                [ content []
                    ...
                    """
                        ...
                        , text """
                    possible configurations. Luckily, we try to optimize what Zeitplan is doing, so it only occasionally
                    has to check more than the first of these.
                    """
                        ]
                    ]
                ]
